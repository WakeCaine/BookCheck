...
public class BookTestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void queryBooksAmazon(String searchString){
        mDialog.show();
        new SearchAmazon().searchForBook(searchString, mDialog, mAmazonAdapter, textExtractService);
    }
